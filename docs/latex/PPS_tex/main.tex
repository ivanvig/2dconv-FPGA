...
\graphicspath{{figures/}{../../schematics/svg/}{../../schematics/imagenes/}} % Directory in which figures are stored
...
% Texto extraido del paper. primero comits en español
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.7]{conv1_despl}
