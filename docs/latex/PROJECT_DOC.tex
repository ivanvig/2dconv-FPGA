...
Figure \ref{bram_n} shows a normalized curve of the estimated BRAM resources use
versus the results obtained from synthesis. As expected, it has a linear
behaviour.

\begin{figure*}[!t]
\centering
\subfloat[filtration in Python.]{\includegraphics[width=1.5in]{lenapy}%
\label{mem}}
\hfil
\subfloat[filtration in Board.]{\includegraphics[width=1.5in]{pasted0}%
\label{transmitted}}
