...
\textcolor{red}{Reusing memory columns written by the previous batch results in
...
inputs  \textcolor{red}{relationship}, i.e. when $It(k-1)$ is a multiple of $N+k-1$. That is, there
...
parallelism degree and the iteration number. An example of  \textcolor{red}{data-flow in memories} is shown in Fig.~\ref{algorithm}.  \textcolor{red}{We consider a kernel $k=3$, $N=4$ MAC
...
iteration, \textcolor{red}{data from a new batch is loaded } without overwriting memories 5 and 6. After
processing \textcolor{red}{step}, \textcolor{red}{the data is stored, starting from memory 5 until the last
