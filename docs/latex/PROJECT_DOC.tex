...
in Fig.~\ref{muxes}. Both, the MMBs and PMBs have a number of inputs dependent
on the number of states from the MMU's FSM and multiplexer connections are defined as
