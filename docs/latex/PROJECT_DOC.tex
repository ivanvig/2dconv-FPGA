...
% in the abstract
\begin{abstract}
  In this article we present a hardware architecture to perform a 2D convolution
  in an FPGA when you can not instantiate enough RAM to be able to host the
  complete image. Priority is given to the processing speed, the efficient use
  of resources and a scalable design where you could add as many convolution
  operations in parallel as you wish without having to make major changes in the
  design.
\end{abstract}
