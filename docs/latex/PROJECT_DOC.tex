...
to a MAC. The information flow between memories$\rightarrow$MMU$\rightarrow$MACs$\rightarrow$MMU$\rightarrow$memories is shown
in Fig.~\ref{muxes}. Both, the MMBs and PMBs have a number of inputs proportional to
the number of states from the MMU's FSM and their multiplexers' inputs are defined
respectively as
