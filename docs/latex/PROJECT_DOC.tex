...
\begin{figure}[!t]
\centering
\subfloat[]{\includegraphics[scale=0.4]{mem_space2}%
\label{mem}}
\hfil \vspace{-0.5cm}
\subfloat[]{\includegraphics[scale=0.4]{data_sent}%
\label{transmitted}}
...
\subfloat[]{\includegraphics[scale=1.1]{shaped_c}
  \label{fig:share}}
\hfil
\subfloat[]{\includegraphics[scale=1.1]{emboss_c}
\label{fig:embossing}}
...
\begin{figure}[!t]
\centering
\includegraphics[scale=0.4]{BRAM_c}
