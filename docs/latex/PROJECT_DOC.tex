...
\begin{figure}[!t]
\centering
\subfloat[Identity kernel.]{\includegraphics[width=2.5in]{identity_c}}
\hfil
\subfloat[Sharpening kernel.]{\includegraphics[width=2.5in]{shaped_c}}
\hfil
\subfloat[Embossing kernel.]{\includegraphics[width=2.5in]{emboss_c}}
...
\hline
   & \multicolumn{3}{c|}{With DSP{[}n{]}(\%)} & \multicolumn{3}{c|}{Without DSP{[}n{]}(\%)} \\ \hline
P  & DSP            & LUT        & BRAM       & DSP         & LUT           & BRAM         \\ \hline
