...
\subsection{Change of Dinamic Range}
...
respetively. Therefore, replacing in \eqref{conv-org}
...
The complete process is detailed in Fig. X.
...
\begin{figure}[!t]
\centering
\includegraphics[width=3in]{comparation2}
\caption{On the left, an image processed in a PC using python. On the right the
  same image processed with the FPGA module.}
\label{images_py_bo2}
\end{figure}
