...
sum every term. Finally, it truncates the result and then stores it into memory first position.
...
units. For this reason, MAC units in parallel produce contiguous processed
