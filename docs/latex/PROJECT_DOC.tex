...
Siguiendo la tendencia actual en la comunidad de deep learning de no
espejar el filtro, pues este debe ser aprendido de todas formas
\cite{Goodfellow-et-al-2016}, se obteniendo la funci\'on de correlacion cruzada
